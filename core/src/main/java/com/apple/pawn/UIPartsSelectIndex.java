...
public class UIPartsSelectIndex extends UIPartsSelect{
    ...
    public UIPartsSelectIndex(String name, int x, int y, int width, int height, boolean isObstruction, String index, String... choices) {
        super(name, x, y, width, height, isObstruction, choices);
        this.index = index;
    }
